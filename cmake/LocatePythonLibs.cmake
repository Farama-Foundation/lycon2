...
if (NOT DEFINED ${PYTHON_BIN})
  ...
  if (DEFINED ENV{DOCKER_PYTHON_VERSION})
    message(STATUS "DOCKER_PYTHON_VERSION=$ENV{DOCKER_PYTHON_VERSION}")
    string(SUBSTRING $ENV{DOCKER_PYTHON_VERSION} 0 1 PYTHON_MAJOR_VERSION)
    string(SUBSTRING $ENV{DOCKER_PYTHON_VERSION} 2 1 PYTHON_MINOR_VERSION)
    set(VERSION_STR ${PYTHON_MAJOR_VERSION}${PYTHON_MINOR_VERSION})
    set(PYTHON_BIN /opt/python/cp${VERSION_STR}-cp${VERSION_STR}m/x64/bin/python)
  else()
